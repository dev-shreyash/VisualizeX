...
function OnlineIDE() {
  ...
  return (
    ...
    <div className="flex w-full h-full z-50 absolute  items-center justify-center bg-gray-900/50">
    <div className="flex-col items-center justify-center p-5">
      ...
      <Button className="ml-4" onClick={() => router.push("/dashboard")}> Go back to dashboard</Button>
    </div>
